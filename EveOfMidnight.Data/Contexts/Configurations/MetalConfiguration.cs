...
{
    public partial class MetalConfiguration : IEntityTypeConfiguration<Metal>
    {
        public void Configure(EntityTypeBuilder<Metal> entity)
        {
            ...
            entity.HasOne(d => d.Rarity)
                ...
                .HasConstraintName("FK_Metals_Rarities");

            OnConfigurePartial(entity);
        }

        partial void OnConfigurePartial(EntityTypeBuilder<Metal> entity);
    }
}
